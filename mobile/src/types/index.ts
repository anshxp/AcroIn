...
export interface User {
  /** User._id from JWT — use for chats, notifications, post likes. */
  id: string;
  authUserId?: string;
  /** Student/Faculty document _id — use for profile and student-scoped APIs. */
  profileId?: string;
  _id?: string;
  email: string;
  name: string;
...
export type ProfileStackParamList = {
  ...
  Skills: undefined;
  BrowseOpportunities: undefined;
  PostOpportunities: undefined;
  SmartSearch: undefined;
  VerifyStudents: undefined;
  StudentProfileView: { id: string };
};

export type ChatStackParamList = {
  ChatListMain: undefined;
  ChatWindow: { chatId: string; participantName?: string };
  NewChat: undefined;
};
